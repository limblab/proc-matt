...
% %     'Chewie','2015-12-04','VR','CO'; ... %54 S(M) - 45 CCW
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%% Chewie (M1 and PMd)
%     'Chewie','2016-09-09','VR','CO'; ... %1 S(M+P) - 30 CW
%     'Chewie','2016-09-12','VR','CO'; ... %2 S(M+P) - 30 CCW
%     'Chewie','2016-09-13','FF','CO'; ... %3 S(M+P) - 0.05 1.48 CCW - Had amplifier problems in PMd so less neurons than there should be, behavior adaptation isn't great
%     'Chewie','2016-09-14','VR','CO'; ... %4 S(M+P) - 30 CW
%     'Chewie','2016-09-15','FF','CO'; ... %5 S(M+P) - 0.05 1.48 CW - lots of neurons
%     'Chewie','2016-09-16','VR','CO'; ... %6 - 30 CCW
    'Chewie','2016-09-19','FF','CO'; ... %7 S(M+P) - 0.05 1.48 CCW - lots of neurons
%     'Chewie','2016-09-20','VR','CO'; ... %8 - 30 CW
%     'Chewie','2016-09-21','FF','CO'; ... %9 - 0.05 1.48 CW
%     'Chewie','2016-09-22','VR','CO'; ... %10 - 30 CCW
%     'Chewie','2016-09-23','FF','CO'; ... %11 - 0.05 1.48 CCW
%     'Chewie','2016-09-27','VR','CO'; ... %12 - 30 CW (FIXED JACOBIAN)
%     'Chewie','2016-09-28','FF','CO'; ... %13 - 0.05 1.48 CCW (BSOD, WO IS TWO FILES)
%     'Chewie','2016-09-29','VR','CO'; ... %14 - 30 CW
%     'Chewie','2016-09-30','FF','CO'; ... %15 - 0.05 1.48 CCW (PAUSED M1)
%     'Chewie','2016-10-05','FF','CO'; ... %16 S(M+P) - 0.05 1.48 CCW
%     'Chewie','2016-10-06','VR','CO'; ... %17 - 30 CW
%     'Chewie','2016-10-05','FF','CO'; ... %18 S(M+P) - 0.05 1.48 CW
